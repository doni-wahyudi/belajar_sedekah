...
export const recipients = [
  {
    ...
    badgeColor: '#73a932',
    avatarBg: 'linear-gradient(135deg, #15803d 0%, #4ade80 100%)',
    quote: 'Alhamdulillah, terima kasih banyak nak Despa dan adik-adik Belajar Sedekah atas paket makanan dan santunannya setiap hari Jum’at. Sangat membantu kami.',
    stars: 5,
  },
  {
    id: 'pak-herman',
    ...
    badgeColor: '#0284c7',
    avatarBg: 'linear-gradient(135deg, #0369a1 0%, #38bdf8 100%)',
    quote: 'Bantuan paket sembako dan bingkisan lebaran ini sangat membantu keluarga kami menyambut Idul Fitri dengan penuh rasa bahagia dan syukur.',
    stars: 5,
  },
  {
    id: 'anisa-sobat-bs',
    ...
    category: 'Sobat BS',
    program: 'Komunitas Sobat BS',
    badgeColor: '#8b5cf6',
    avatarBg: 'linear-gradient(135deg, #6d28d9 0%, #a78bfa 100%)',
    quote: 'Di Belajar Sedekah saya belajar arti ketulusan. Senang sekali bisa bertumbuh, mengabdi, dan berbagi bersama teman-teman muda yang satu frekuensi.',
    stars: 5,
  },
];
